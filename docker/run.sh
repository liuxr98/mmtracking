...
## mmtracking notebook
docker run --rm -d --name mmtracking_env -p 18888:8888 -p 19010:5000 -v $(pwd)/mmtracking:/workdir --shm-size 8G --gpus all -e NVIDIA_DRIVER_CAPABILITIES=compute,utility -e NVIDIA_VISIBLE_DEVICES=all liuxr25/track:mmtracking_cuda11.3_torch1.12.0_jupyter
